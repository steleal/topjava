...
<section>
    ...
    <form method="post" action="meals/filter">
        ...
        <button type="submit"><spring:message code="cmd.filter"/></button>
    </form>
    <hr/>
    <a href="meals/create"><spring:message code="cmd.add"/></a>
    <br><br>
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        <c:forEach items="${requestScope.meals}" var="meal">
            ...
            <tr data-meal-excess="${meal.excess}">
                ...
                <td>${meal.calories}</td>
                <td><a href="meals/update?id=${meal.id}"><spring:message code="cmd.update"/></a></td>
                <td><a href="meals/delete?id=${meal.id}"><spring:message code="cmd.delete"/></a></td>
            </tr>
        </c:forEach>
    </table>
</section>
